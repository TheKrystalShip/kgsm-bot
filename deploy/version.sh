...
#
# The version is declared in exactly ONE place — src/KGSM.Bot.Discord/KGSM.Bot.Discord.csproj — and read from there, so the package,
# the binary and the changelog can never disagree about what this is.
#
# KGSM.Bot.Discord is the deployable; the Core/Application/Infrastructure libraries carry none.
...
SOURCE_FILE="${HERE}/../src/KGSM.Bot.Discord/KGSM.Bot.Discord.csproj"
