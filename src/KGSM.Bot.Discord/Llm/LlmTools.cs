...
/// <summary>
/// The whitelist of tools the model may call. Each entry maps 1:1 onto a MediatR
/// request in <see cref="ToolDispatcher"/>.
///
...
///    happens only after an explicit human button-confirmation (see
///    <c>ConfirmationModule</c>). These are the data-losing / heavy ops.
/// </summary>
