...
public class ServerAssistantTests
{
    ...
    private ServerAssistant Create()
    {
        ...
        return new ServerAssistant(_agent, _prompt, _confirmations, NullLogger<ServerAssistant>.Instance);
    }
    ...
    private async Task<AgentTurn> CaptureTurnAsync(bool canPerformActions)
    {
        ...
        await Create().RunAsync(User, Channel, "do it", canPerformActions);
